...
| REQ-015 | `_includes/footer.html` SHALL render a footer containing a CC BY 4.0 licence link and the text "Adrian Rossouw, 2026". No em-dashes. |
...
| REQ-025 | The about page SHALL include a contact section as `dl.bio-grid` with rows for Email (`formicary@localghost.ie`), Writing, Feed, and Licence. No em-dashes in contact copy. |
